...
HTTP response headers will contain an [`ETag`][etag] response header instead of a [`Last-Modified`][last-modified] header. Opt-in because calculating the hash value may be computationally expensive.
